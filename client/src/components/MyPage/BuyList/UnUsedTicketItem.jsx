import {Accordion, Typography, AccordionSummary, AccordionDetails,Button,Grid,Box} from '@mui/material';
            ...
            <Typography  sx={{fontSize:20 ,fontWeight:'bolder'}}>
              ...
              <AccordionDetails className='detail'>
                <Typography  sx={{fontSize:13 ,fontWeight:'bold'}}>
                  ...
                  소유자 : {ticket.owner}<br/>
                  구매자 : {ticket.buyer}<br/>
                  코드번호 : {ticket.identifier}<br/><br/>
                
                    <Button className='transfer_btn'  variant="contained">양도하기</Button>
